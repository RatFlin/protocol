...
type UserClient interface {
	...
	// 获取用户私钥
	GetUserPrivateKey(ctx context.Context, in *GetUserPrivateKeyReq, opts ...grpc.CallOption) (*GetUserPrivateKeyResp, error)
	// 获取用户证书
...
func (c *userClient) GetUserPrivateKey(ctx context.Context, in *GetUserPrivateKeyReq, opts ...grpc.CallOption) (*GetUserPrivateKeyResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserPrivateKeyResp)
	err := c.cc.Invoke(ctx, User_GetUserPrivateKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetUserCertificate(ctx context.Context, in *GetUserCertificateReq, opts ...grpc.CallOption) (*GetUserCertificateResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserCertificateResp)
	err := c.cc.Invoke(ctx, User_GetUserCertificate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetSeed(ctx context.Context, in *GetSeedRequest, opts ...grpc.CallOption) (*GetSeedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSeedResponse)
	err := c.cc.Invoke(ctx, User_GetSeed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	// 获取用户私钥
	GetUserPrivateKey(context.Context, *GetUserPrivateKeyReq) (*GetUserPrivateKeyResp, error)
	// 获取用户证书
...
func (UnimplementedUserServer) GetUserPrivateKey(context.Context, *GetUserPrivateKeyReq) (*GetUserPrivateKeyResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserPrivateKey not implemented")
}
func (UnimplementedUserServer) GetUserCertificate(context.Context, *GetUserCertificateReq) (*GetUserCertificateResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserCertificate not implemented")
}
...
func _User_GetUserPrivateKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserPrivateKeyReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetUserPrivateKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetUserPrivateKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserPrivateKey(ctx, req.(*GetUserPrivateKeyReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _User_GetUserCertificate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserCertificateReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetUserCertificate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetUserCertificate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserCertificate(ctx, req.(*GetUserCertificateReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _User_GetSeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSeedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetSeed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetSeed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetSeed(ctx, req.(*GetSeedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetUserPrivateKey",
			Handler:    _User_GetUserPrivateKey_Handler,
		},
		{
			MethodName: "GetUserCertificate",
			Handler:    _User_GetUserCertificate_Handler,
		},
		{
			MethodName: "GetSeed",

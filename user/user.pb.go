...
type GetUserPrivateKeyResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PrivateKey    string                 `protobuf:"bytes,1,opt,name=privateKey,proto3" json:"privateKey"` // 16进制字符串
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_user_proto_rawDesc = "" +
	...
	"\vcertificate\x18\x01 \x01(\tR\vcertificate2\xcc\x18\n" +
	"\x04user\x12Z\n" +
	...
	"\x12GetUserCertificate\x12\".openim.user.GetUserCertificateReq\x1a#.openim.user.GetUserCertificateRespB$Z\"github.com/openimsdk/protocol/userb\x06proto3"
...
var file_user_user_proto_depIdxs = []int32{
	...
	79, // 96: openim.user.user.GetUserPrivateKey:output_type -> openim.user.GetUserPrivateKeyResp
	81, // 97: openim.user.user.GetUserCertificate:output_type -> openim.user.GetUserCertificateResp
